...
public class ListProducts {
    ...
    public ListProducts(int width, int height, String title, String location, String CarText, String Name) {
        ...
        // Adding TypeText
        Text TypeText = new Text(this.frame, 350, 30, 300, 100, CarText, "C:\\Users\\Abdullah\\Desktop\\DatabaseProject\\src\\main\\Fonts\\Montserrat-Bold.ttf", 40f);
        ...
        if (array.size() == 0){
            Text sorry = new Text(this.frame, 670, 350, 250, 40, "No Products Exist!", "C:\\Users\\Abdullah\\Desktop\\DatabaseProject\\src\\main\\Fonts\\Montserrat-SemiBold.ttf", 25f);
